                    ...
                    <div className="accordion" id="accordion-tab-1">
                        ...
                        <div className="card">
                            <div className="card-header" id="accordion-tab-1-heading-4">
                                <h5>
                                    <button className="btn btn-link faq-content-link" type="button" data-toggle="collapse" data-target="#accordion-tab-1-content-4" aria-expanded="false" aria-controls="accordion-tab-1-content-4">Vegan On-time Delivery</button>
                                </h5>
                            </div>
                    ...
                    <div className="accordion" id="accordion-tab-2">
                        <div className="card">
                            <div className="card-header" id="accordion-tab-2-heading-1">
                                <h5>
                                    <button className="btn btn-link faq-content-link" type="button" data-toggle="collapse" data-target="#accordion-tab-2-content-1" aria-expanded="false" aria-controls="accordion-tab-2-content-1">What is Vegan Customer Care Number</button>
                                </h5>
                            </div>
                            <div className="collapse show" id="accordion-tab-2-content-1" aria-labelledby="accordion-tab-2-heading-1" data-parent="#accordion-tab-2">
                                <div className="card-body">
                                    <p>We value our customer’s time and hence moved away from a single customer care number to a comprehensive chat-based support system for quick and easy resolution. You no longer have to go through the maze of an IVRS call support. Just search for your issue in the help section on this page and initiate a chat with us. A customer care executive will be assigned to you shortly. You can also email us your issue on support@Vegan.com
Note: We value your privacy and your information is safe with us. Please do not reveal any personal information, bank account number, OTP etc. to another person. A Vegan compresentative will never ask you for these details. Please do not reveal these details to fraudsters and imposters claiming to be calling on our behalf. Be vigilant and do not entertain phishing calls or emails.</p>
                                </div>
                            </div>
                        </div>
                        <div className="card">
                            ...
                            <div className="collapse" id="accordion-tab-2-content-2" aria-labelledby="accordion-tab-2-heading-2" data-parent="#accordion-tab-2">
                                <div className="card-body">
                                    <p><a href="/sell">Sell with us</a> please send us mail at support@Vegan.com </p>
                                </div>
                            </div>
                        </div>
                        <div className="card">
                        ...
                        <div className="card">
                            ...
                            <div className="collapse" id="accordion-tab-2-content-4" aria-labelledby="accordion-tab-2-heading-4" data-parent="#accordion-tab-2">
                                <div className="card-body">
                                    <p>please send us mail at support@Vegan.com </p>
                                </div>
                            </div>
                        </div>
                    </div>
