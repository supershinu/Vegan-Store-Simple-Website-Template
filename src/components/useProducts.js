...
return{
    ...
    onAddCart : async(product) => {
      ...
      buy:(value) => {
          History.push('/Vegan-online-vegetable-shopping-reactjs/'+value);
      },
                ...
                if(res){
                    ...
                    userCartItem.get().then(function(doc) {
                        ...
                        if(user.email===null){
                            ...
                            History.push('/Vegan-online-vegetable-shopping-reactjs');
                                }
                            } 
      ...
      signUp:(e)=>{
            ...
            if(pwdLogin === cnfPwdLogin){
                if(user.email!==null){
                    ...
                    if(res){
                        History.push('/Vegan-online-vegetable-shopping-reactjs/products')
                    }
                    })
                    .catch((err)=>{
                        console.log(err)
        ...
        transcationSuccess:(data,cartItem) => {
             ...
             .then(function() {
                 ...
                 setCartItems([]);
                History.push("/Vegan-online-vegetable-shopping-reactjs/orderConfirmation");
            }).catch(function(error) {
        ...
        onCheckout:(e) => {
            History.push("/Vegan-online-vegetable-shopping-reactjs/checkout");
        }
